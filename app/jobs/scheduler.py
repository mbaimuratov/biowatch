...
from app.services.telegram_deliveries import enqueue_due_morning_deliveries
...
async def run_scheduler_loop() -> None:
    ...
    while True:
        async with SessionLocal() as session:
            result = await enqueue_due_morning_deliveries(
                session,
                delivery_queue,
            ...
            if result.deliveries_enqueued:
                logger.info(
                    "Queued Telegram morning deliveries",
                    extra={
