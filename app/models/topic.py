...
class Topic(Base):
    ...
    __table_args__ = (
        ...
        CheckConstraint("max_results_per_run > 0", name="ck_topics_max_results_per_run_positive"),
    )
    ...
    max_results_per_run: Mapped[int] = mapped_column(Integer, default=25, nullable=False)
